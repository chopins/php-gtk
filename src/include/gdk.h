...
extern extern GdkGrabStatus gdk_device_grab (GdkDevice *device,GdkWindow *window,GdkGrabOwnership grab_ownership,gboolean owner_events,GdkEventMask event_mask,GdkCursor *cursor,guint32 time_);
extern extern void gdk_device_ungrab (GdkDevice *device,guint32 time_);
extern void gdk_device_warp (GdkDevice *device,GdkScreen *screen,gint x,gint y);
extern extern gboolean gdk_device_grab_info_libgtk_only (GdkDisplay *display,GdkDevice *device,GdkWindow **grab_window,gboolean *owner_events);
...
extern extern GList * gdk_device_manager_list_devices (GdkDeviceManager *device_manager,GdkDeviceType type);
extern extern GdkDevice * gdk_device_manager_get_client_pointer (GdkDeviceManager *device_manager);
...
extern extern GdkWindow* gdk_window_at_pointer (gint *win_x,gint *win_y);
...
extern extern gboolean gdk_window_get_composited (GdkWindow *window);
extern extern void gdk_window_set_composited (GdkWindow *window,gboolean composited);
...
extern extern gboolean gdk_window_set_static_gravities (GdkWindow *window,gboolean use_static);
...
extern extern void gdk_window_begin_paint_rect (GdkWindow *window,const GdkRectangle *rectangle);
extern void gdk_window_mark_paint_from_clip (GdkWindow *window,cairo_t *cr);
extern extern void gdk_window_begin_paint_region (GdkWindow *window,const cairo_region_t *region);
extern extern void gdk_window_end_paint (GdkWindow *window);
...
extern extern void gdk_window_flush (GdkWindow *window);
...
extern extern void gdk_window_set_background (GdkWindow *window,const GdkColor *color);
extern extern void gdk_window_set_background_rgba (GdkWindow *window,const GdkRGBA *rgba);
extern extern void gdk_window_set_background_pattern (GdkWindow *window,cairo_pattern_t *pattern);
extern extern cairo_pattern_t *gdk_window_get_background_pattern (GdkWindow *window);
...
extern extern GdkWindow * gdk_window_get_pointer (GdkWindow *window,gint *x,gint *y,GdkModifierType *mask);
...
extern GdkFullscreenModegdk_window_get_fullscreen_mode (GdkWindow *window);
...
extern GdkDragProtocolgdk_window_get_drag_protocol(GdkWindow *window,GdkWindow **target);
...
extern extern void gdk_window_freeze_toplevel_updates_libgtk_only (GdkWindow *window);
extern extern void gdk_window_thaw_toplevel_updates_libgtk_only (GdkWindow *window);
extern extern void gdk_window_process_all_updates (void);
extern extern void gdk_window_process_updates (GdkWindow *window,gboolean update_children);
extern extern void gdk_window_set_debug_updates (gboolean setting);
...
extern extern void gdk_window_enable_synchronized_configure (GdkWindow *window);
extern extern void gdk_window_configure_finished (GdkWindow *window);
...
extern GdkSeatCapabilitiesgdk_seat_get_capabilities (GdkSeat *seat);
...
extern extern gint gdk_display_get_n_screens (GdkDisplay *display);
extern extern GdkScreen * gdk_display_get_screen (GdkDisplay *display,gint screen_num);
extern GdkScreen * gdk_display_get_default_screen (GdkDisplay *display);
extern extern void gdk_display_pointer_ungrab (GdkDisplay *display,guint32 time_);
extern extern void gdk_display_keyboard_ungrab (GdkDisplay *display,guint32 time_);
extern extern gboolean gdk_display_pointer_is_grabbed (GdkDisplay *display);
...
extern extern GList * gdk_display_list_devices (GdkDisplay *display);
...
extern extern void gdk_display_get_pointer (GdkDisplay *display,GdkScreen **screen,gint *x,gint *y,GdkModifierType *mask);
extern extern GdkWindow * gdk_display_get_window_at_pointer (GdkDisplay *display,gint *win_x,gint *win_y);
extern extern void gdk_display_warp_pointer (GdkDisplay *display,GdkScreen *screen,gint x,gint y);
extern extern GdkDisplay *gdk_display_open_default_libgtk_only (void);
...
extern extern gboolean gdk_display_supports_composite (GdkDisplay *display);
extern void gdk_display_notify_startup_complete (GdkDisplay *display,const gchar *startup_id);
extern extern GdkDeviceManager * gdk_display_get_device_manager (GdkDisplay *display);
...
extern extern gint gdk_screen_get_number (GdkScreen *screen);
extern extern gint gdk_screen_get_width (GdkScreen *screen);
extern extern gint gdk_screen_get_height (GdkScreen *screen);
extern extern gint gdk_screen_get_width_mm (GdkScreen *screen);
extern extern gint gdk_screen_get_height_mm (GdkScreen *screen);
extern GList * gdk_screen_list_visuals (GdkScreen *screen);
extern GList * gdk_screen_get_toplevel_windows (GdkScreen *screen);
extern extern gchar * gdk_screen_make_display_name (GdkScreen *screen);
extern extern gint gdk_screen_get_n_monitors (GdkScreen *screen);
extern extern gint gdk_screen_get_primary_monitor (GdkScreen *screen);
extern extern void gdk_screen_get_monitor_geometry (GdkScreen *screen,gint monitor_num,GdkRectangle *dest);
extern extern void gdk_screen_get_monitor_workarea (GdkScreen *screen,gint monitor_num,GdkRectangle *dest);
extern extern gint gdk_screen_get_monitor_at_point (GdkScreen *screen,gint x,gint y);
extern extern gint gdk_screen_get_monitor_at_window (GdkScreen *screen,GdkWindow *window);
extern extern gint gdk_screen_get_monitor_width_mm (GdkScreen *screen,gint monitor_num);
extern extern gint gdk_screen_get_monitor_height_mm (GdkScreen *screen,gint monitor_num);
extern extern gchar * gdk_screen_get_monitor_plug_name (GdkScreen *screen,gint monitor_num);
extern extern gint gdk_screen_get_monitor_scale_factor (GdkScreen *screen,gint monitor_num);
...
extern extern GdkWindow *gdk_screen_get_active_window (GdkScreen *screen);
extern GList *gdk_screen_get_window_stack (GdkScreen *screen);
extern GType gdk_app_launch_context_get_type (void);
extern extern GdkAppLaunchContext *gdk_app_launch_context_new (void);
extern extern void gdk_app_launch_context_set_display (GdkAppLaunchContext *context,GdkDisplay *display);
...
extern extern GType gdk_color_get_type (void);
extern extern GdkColor *gdk_color_copy (const GdkColor *color);
extern extern void gdk_color_free (GdkColor *color);
extern extern guint gdk_color_hash (const GdkColor *color);
extern extern gboolean gdk_color_equal (const GdkColor *colora,const GdkColor *colorb);
extern extern gboolean gdk_color_parse (const gchar *spec,GdkColor *color);
extern extern gchar * gdk_color_to_string (const GdkColor *color);
...
extern extern PangoContext *pango_cairo_font_map_create_context (PangoCairoFontMap *fontmap);
...
extern extern void gdk_cairo_set_source_color (cairo_t *cr,const GdkColor *color);
...
extern extern GdkCursor* gdk_cursor_new (GdkCursorType cursor_type);
...
extern extern GdkCursor * gdk_cursor_ref (GdkCursor *cursor);
extern extern void gdk_cursor_unref (GdkCursor *cursor);
...
extern extern GdkKeymap* gdk_keymap_get_default (void);
...
extern extern void gdk_add_option_entries_libgtk_only (GOptionGroup *group);
extern extern void gdk_pre_parse_libgtk_only (void);
...
extern extern void gdk_error_trap_push (void);
extern extern  gint gdk_error_trap_pop (void);
extern extern void gdk_error_trap_pop_ignored (void);
extern const gchar * gdk_get_display_arg_name (void);
extern gchar* gdk_get_display (void);
extern extern GdkGrabStatus gdk_pointer_grab (GdkWindow *window,gboolean owner_events,GdkEventMask event_mask,GdkWindow *confine_to,GdkCursor *cursor,guint32 time_);
extern extern GdkGrabStatus gdk_keyboard_grab (GdkWindow *window,gboolean owner_events,guint32 time_);
extern extern void gdk_pointer_ungrab (guint32 time_);
extern extern void gdk_keyboard_ungrab (guint32 time_);
extern extern gboolean gdk_pointer_is_grabbed (void);
extern extern gint gdk_screen_width (void);
extern extern gint gdk_screen_height (void);
extern extern gint gdk_screen_width_mm (void);
extern extern gint gdk_screen_height_mm (void);
extern extern void gdk_set_double_click_time (guint msec);
extern extern void gdk_beep (void);
extern extern void gdk_flush (void);
...
extern extern void gdk_threads_init (void);
extern extern void gdk_threads_enter (void);
extern extern void gdk_threads_leave (void);
extern extern void gdk_threads_set_lock_functions (GCallback enter_fn,GCallback leave_fn);
...
extern extern gint gdk_visual_get_best_depth (void);
extern extern GdkVisualType gdk_visual_get_best_type (void);
extern extern GdkVisual* gdk_visual_get_system (void);
extern extern GdkVisual* gdk_visual_get_best (void);
extern extern GdkVisual* gdk_visual_get_best_with_depth (gint depth);
extern extern GdkVisual* gdk_visual_get_best_with_type (GdkVisualType visual_type);
extern extern GdkVisual* gdk_visual_get_best_with_both (gint depth,GdkVisualType visual_type);
extern extern void gdk_query_depths (gint **depths,gint *count);
extern extern void gdk_query_visual_types (GdkVisualType **visual_types,gint *count);
extern extern GList* gdk_list_visuals (void);
...
extern extern GdkByteOrder gdk_visual_get_byte_order (GdkVisual *visual);
extern extern gint gdk_visual_get_colormap_size (GdkVisual *visual);
extern extern gint gdk_visual_get_bits_per_rgb (GdkVisual *visual);
