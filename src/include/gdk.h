...
GDK_AVAILABLE_IN_3_22 GdkAxisFlags gdk_device_get_axes (GdkDevice *device);
...
GDK_AVAILABLE_IN_3_22 GType gdk_device_tool_get_type (void);
GDK_AVAILABLE_IN_3_22 guint64 gdk_device_tool_get_serial (GdkDeviceTool *tool);
GDK_AVAILABLE_IN_3_22 guint64 gdk_device_tool_get_hardware_id (GdkDeviceTool *tool);
GDK_AVAILABLE_IN_3_22 GdkDeviceToolType gdk_device_tool_get_tool_type (GdkDeviceTool *tool);
...
GDK_AVAILABLE_IN_3_22 GdkDeviceTool *gdk_event_get_device_tool (const GdkEvent *event);
GDK_AVAILABLE_IN_3_22 void gdk_event_set_device_tool (GdkEvent *event,GdkDeviceTool *tool);
GDK_AVAILABLE_IN_3_22 int gdk_event_get_scancode (GdkEvent *event);
GDK_AVAILABLE_IN_3_22 gboolean gdk_event_get_pointer_emulated (GdkEvent *event);
...
GDK_AVAILABLE_IN_3_22 GType gdk_drawing_context_get_type (void);
GDK_AVAILABLE_IN_3_22 GdkWindow * gdk_drawing_context_get_window (GdkDrawingContext *context);
GDK_AVAILABLE_IN_3_22 cairo_region_t *gdk_drawing_context_get_clip (GdkDrawingContext *context);
GDK_AVAILABLE_IN_3_22 gboolean gdk_drawing_context_is_valid (GdkDrawingContext *context);
GDK_AVAILABLE_IN_3_22 cairo_t * gdk_drawing_context_get_cairo_context (GdkDrawingContext *context);
...
GDK_AVAILABLE_IN_3_24 void gdk_window_move_to_rect (GdkWindow *window,const GdkRectangle *rect,GdkGravity rect_anchor,GdkGravity window_anchor,GdkAnchorHints anchor_hints,gint rect_anchor_dx,gint rect_anchor_dy);
...
GDK_AVAILABLE_IN_3_22 GdkDrawingContext *gdk_window_begin_draw_frame (GdkWindow *window,const cairo_region_t *region);
...
GDK_AVAILABLE_IN_3_22 GType gdk_monitor_get_type (void);
GDK_AVAILABLE_IN_3_22 GdkDisplay * gdk_monitor_get_display (GdkMonitor *monitor);
GDK_AVAILABLE_IN_3_22 void gdk_monitor_get_geometry (GdkMonitor *monitor,GdkRectangle *geometry);
GDK_AVAILABLE_IN_3_22 void gdk_monitor_get_workarea (GdkMonitor *monitor,GdkRectangle *workarea);
GDK_AVAILABLE_IN_3_22 int gdk_monitor_get_width_mm (GdkMonitor *monitor);
GDK_AVAILABLE_IN_3_22 int gdk_monitor_get_height_mm (GdkMonitor *monitor);
...
GDK_AVAILABLE_IN_3_22 int gdk_monitor_get_scale_factor (GdkMonitor *monitor);
GDK_AVAILABLE_IN_3_22 int gdk_monitor_get_refresh_rate (GdkMonitor *monitor);
...
GDK_AVAILABLE_IN_3_22 int gdk_display_get_n_monitors (GdkDisplay *display);
GDK_AVAILABLE_IN_3_22 GdkMonitor * gdk_display_get_monitor (GdkDisplay *display,int monitor_num);
GDK_AVAILABLE_IN_3_22 GdkMonitor * gdk_display_get_primary_monitor (GdkDisplay *display);
GDK_AVAILABLE_IN_3_22 GdkMonitor * gdk_display_get_monitor_at_point (GdkDisplay *display,int x,int y);
GDK_AVAILABLE_IN_3_22 GdkMonitor * gdk_display_get_monitor_at_window (GdkDisplay *display,GdkWindow *window);
...
GDK_AVAILABLE_IN_3_22 GdkDrawingContext * gdk_cairo_get_drawing_context (cairo_t *cr);
...
GDK_AVAILABLE_IN_3_22 GType gdk_device_pad_get_type (void);
GDK_AVAILABLE_IN_3_22 gint gdk_device_pad_get_n_groups (GdkDevicePad *pad);
GDK_AVAILABLE_IN_3_22 gint gdk_device_pad_get_group_n_modes (GdkDevicePad *pad,gint group_idx);
GDK_AVAILABLE_IN_3_22 gint gdk_device_pad_get_n_features (GdkDevicePad *pad,GdkDevicePadFeature feature);
GDK_AVAILABLE_IN_3_22 gint gdk_device_pad_get_feature_group (GdkDevicePad *pad,GdkDevicePadFeature feature,gint feature_idx);
...
GDK_AVAILABLE_IN_3_22 void gdk_gl_context_set_use_es (GdkGLContext *context,int use_es);
GDK_AVAILABLE_IN_3_22 gboolean gdk_gl_context_get_use_es (GdkGLContext *context);
...
GDK_AVAILABLE_IN_3_22 PangoContext *gdk_pango_context_get_for_display (GdkDisplay *display);
