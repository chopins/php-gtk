...
extern extern GdkPixbuf *gdk_pixbuf_ref (GdkPixbuf *pixbuf);
extern extern void gdk_pixbuf_unref (GdkPixbuf *pixbuf);
...
extern extern GdkPixbuf* gdk_pixbuf_new_from_inline (gint data_length,const guint8 *data,gboolean copy_pixels,GError **error);
...
extern extern GdkPixbufAnimation *gdk_pixbuf_animation_ref (GdkPixbufAnimation *animation);
extern extern void gdk_pixbuf_animation_unref (GdkPixbufAnimation *animation);
