LIBGTK_FUNC_AVAILABLE_IN_UINX GType pango_coverage_get_type(void);
...
LIBGTK_FUNC_AVAILABLE_IN_UINX GType pango_attribute_get_type(void);
...
extern PangoAttribute *pango_attr_font_features_new(const gchar *features);
...
extern void pango_attr_list_splice(PangoAttrList *list, PangoAttrList *other, gint pos, gint len);
...
extern void pango_attr_iterator_range(PangoAttrIterator *iterator, gint *start, gint *end);
...
extern void pango_find_paragraph_boundary(const gchar *text, gint length, gint *paragraph_delimiter_index, gint *next_paragraph_start);
extern void pango_get_log_attrs(const char *text, int length, int level, PangoLanguage *language, PangoLogAttr *log_attrs, int attrs_len);
extern void pango_default_break(const gchar *text, int length, PangoAnalysis *analysis, PangoLogAttr *attrs, int attrs_len);
PANGO_AVAILABLE_IN_1_44 void pango_tailor_break(const char *text, int length, PangoAnalysis *analysis, int offset, PangoLogAttr *log_attrs, int log_attrs_len);
...
extern void pango_glyph_string_set_size(PangoGlyphString *string, gint new_len);
...
extern void pango_glyph_string_index_to_x(PangoGlyphString *glyphs, char *text, int length, PangoAnalysis *analysis, int index_, gboolean trailing, int *x_pos);
extern void pango_glyph_string_x_to_index(PangoGlyphString *glyphs, char *text, int length, PangoAnalysis *analysis, int x_pos, int *index_, int *trailing);
...
LIBGTK_FUNC_AVAILABLE_IN_UINX GType pango_show_flags_get_type(void);
...
LIBGTK_FUNC_AVAILABLE_IN_UINX GType pango_shape_flags_get_type(void);
...
PANGO_AVAILABLE_IN_1_44 void pango_layout_line_get_x_ranges(PangoLayoutLine *line, int start_index, int end_index, int **ranges, int *n_ranges);
