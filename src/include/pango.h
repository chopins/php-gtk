GLIB_AVAILABLE_IN_UINX GType pango_coverage_get_type(void);
...
GLIB_AVAILABLE_IN_UINX GType pango_attribute_get_type(void);
...
GLIB_AVAILABLE_IN_UINX GType pango_show_flags_get_type(void);
...
GLIB_AVAILABLE_IN_UINX GType pango_shape_flags_get_type(void);
