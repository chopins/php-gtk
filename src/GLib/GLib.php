...
class GLib extends GtkFFI implements DefineValue
{
    ...
    public function bindMethod()
    {
        $fullMatch = [
            ...
            'g_vasprintf', 'g_vfprintf', 'g_vprintf', 'g_vsnprintf', 'g_vsprintf',
        ...
        return $this->registerCall('glib', self::$glib, $matchPrefix, $fullMatch);
    }

    protected function unimplement($name)
    {
        parent::unimplement($name);
        $list = [
